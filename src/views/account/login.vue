              ...
              <BRow>
                  <BCol lg="12">
                      <BCard no-body class="overflow-hidden">
                          <BRow class="g-0">
                              <BCol lg="6">
                                  <div class="p-lg-5 p-4 align-items-center h-100"> 
                                      <!-- <div class="bg-overlay"></div> -->
                                      <div class="position-relative h-100 d-flex flex-column">
                                          <div class="mb-4">
                                              <router-link to="/" class="d-block">
                                                  <img src="@/assets/images/netra-logo.png" alt="" class="center logosize">
                                              </router-link>
                                          </div>
                                          <div class="mb-3">
                                            <img src="@/assets/images/signin-pict.png" alt="" class="center signpictsize">
                                          </div>
